...
The Standard Model of particle physics divides nature up into two domains: particles and forces. The four fundamental forces are electromagnetism, the strong interaction, the weak interaction, and gravitation (which is not explained within the Standard Model). 
...
In addition to this, there is another class of particles with integer spin called the bosons. These are the \textit{force carriers} or \textit{gauge bosons} -- the exchange of these particles is the medium through which the fundamental forces can affect particles. The electromagnetic interaction is mediated by the photon, the weak interaction is mediated by the W and Z bosons, and the strong interation is mediated by the gluon. 

In the conception of quantum field theory (QFT), each of the fundamental forces is a field that permeates all space. The gauge bosons are excitations or quanta of that field that mediate interactions between particles and the field.

%-Electroweak theory
%-Electroweak symmetry causing problems
%	-Massless W and Z bosons

\subsection{The Higgs boson}
[...]

The Higgs boson arises in the same way that the other gauge bosons do -- the scalar Higgs field permeates all of space, and the Higgs boson is the excitation of this field that mediates its interactions with other matter. In this case, interaction with the Higgs field gives particles mass. The amount of mass a particle has is dependent upon how strongly it interacts with (or couples to) to the Higgs boson. This is the Yukawa coupling, [...]

%-How the Higgs boson solves electroweak symmetry breaking
%-Mechanism that gives W and Z bosons mass
%-Why this results in a Higgs boson
%-Top quark?
