...
Precision measurement of the top quark is also an important test of the \acrshort{SM}. The top quark is most massive particle of the \acrshort{SM}, and as such provides a good prove into the mechanism of electroweak symmetry breaking, and provide insight into the mechanics of it, should they differ from that in the \acrlong{SM} \cite{top-quark-lhc}. 
...
As of writing, the \acrshort{CLIC} project released a \acrfull{CDR} in 2010 detailing the current state of planning for the experiment \cite{clic-cdr-main}. It has also submitted input to the European Particle Physics Strategy Update, which will decide which projects the \acrshort{CERN} collaboration chooses to pursue from 2020 onwards.
