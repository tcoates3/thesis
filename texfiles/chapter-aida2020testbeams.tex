...
\begin{figure}[p]
	\centering
	\includegraphics[width=1\textwidth]{../Pictures/AHCAL-DESY-2016-Beam.jpg}
...
\begin{figure}[t]
	\centering
	\includegraphics[width=1\textwidth]{../Pictures/AHCAL-DESY-2016-Assembled-2.jpg}
	\caption{Close-up of the layers and electronics assembled in the support structure in the beam area. During operation, the assembly is covered with black fabric to block ambient light.}
...
\begin{figure}[p]
	...
	\caption{The \acrshort{CALICE}-\acrshort{AHCAL} being hoisted into the testbeam area during installation, with the layers visible.}
...
\begin{figure}[p]
	...
	\caption{An overview of the testbeam area, with the solenoid the \acrshort{CALICE}-\acrshort{AHCAL} was placed within visible.}
