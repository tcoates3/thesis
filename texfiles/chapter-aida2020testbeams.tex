...
% Nigel: cross-reference the statement on beam structure to the updated table of collider parameters that will include that information.
...
% Nigel: Explain why this is the case (no point repeating this info. in evey event that is produced, store insead in conditions/config database).
