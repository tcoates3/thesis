...
%-Isolated lepton (e and mu) finding
%	-High energy (~50-350GeV)
%	-In low-occupancy parts of the detector
%	-Low impact parameter (IP)
%	-Energy depostion (and ECAL vs HCAL deposition)
