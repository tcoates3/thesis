...
For this analysis, new work used NLO corrections to \acrshort{QCD}, the initial state radiation, and beamstrahlung effects, to determine that $\kappa$ = 0.503 \cite{kappa-NLOQCD}. \\
